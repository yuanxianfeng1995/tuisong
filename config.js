const config = {
    ...
    template_id: "Udm4Ci8yZj4Nxu7sGhcujYY7GaTks4e8VyAFA3xIv_A", // 模板 id
    // 信息配置
    city: "长沙", // 所在城市
    birthday1: { "name": "思卉", "birthday": "9,18" }, // 宝贝生日（阳历），姓名和生日，生日格式为"年-月-日"
    birthday2: { "name": "先锋", "birthday": "1,20" }, // 我的生日，同上
